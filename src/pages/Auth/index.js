...
const Auth = ({resourceUrl, showLoaderGif}) => {
    const onclick = () => {
        showLoaderGif(true);
    };
    return (
        <div className={s.main}>
            ...
            <a onClick={onclick} href={`${resourceUrl}/client/login?deviceType=3&provider=Google`}>
                <img className={s.icon} src={goo} alt="Google"/>
            </a>
            <a onClick={onclick} href={`${resourceUrl}/client/login?deviceType=3&provider=Yandex`}>
                <img className={s.icon} src={ya} alt="Yandex"/>
            </a>
            <a onClick={onclick} href={`${resourceUrl}/client/login?deviceType=3&provider=Facebook`}>
                <img className={s.icon} src={fb} alt="Facebook"/>
            </a>
            <a onClick={onclick} href={`${resourceUrl}/client/login?deviceType=3&provider=VKontakte`}>
